...
nohup uvicorn core.asgi:application --host 0.0.0.0 --port 3010 --lifespan off --ws websockets --ws-ping-interval 50 --ws-ping-timeout 60 > ./logs/django_stdout.log 2>&1 &
