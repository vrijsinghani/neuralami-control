...
Run this script with: python manage.py shell < test_meta_tags_websocket_final.py
"""
...
print("\n\n=== Testing meta tags WebSocket messaging with HTMX (Final) ===\n")

try:
    # Create a mock task ID
    mock_task_id = "test_task_final"
    ...
    status_data = {
        ...
        'result': {
            'success': True,
            'file_path': f"{user.id}/meta-tags/test_websocket_final.csv",
