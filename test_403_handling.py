"""
Test script to verify that the Playwright adapter correctly handles 403 errors.
Run with: python manage.py shell < test_403_handling.py
"""
import sys
import logging
...
# Test URL that might return 403
url = "https://www.paradisefloorsandmore.com/"

print(f"\n\n=== Testing 403 error handling for URL: {url} ===\n")
